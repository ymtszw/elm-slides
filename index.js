...
var _ymtszw$elm_slides$File$separator = _elm_lang$core$Regex$regex('---+\\s+');
var _ymtszw$elm_slides$File$chopFile = function (raw) {
	return A3(_elm_lang$core$Regex$split, _elm_lang$core$Regex$All, _ymtszw$elm_slides$File$separator, raw);
};
var _ymtszw$elm_slides$File$getMarkdown = function (path) {
	return A2(
				...
				A2(
					...
					function (_p1) {
						return A2(
							...
							path,
							_ymtszw$elm_slides$File$chopFile(_p1));
					},
					_p0));
		},
...
var _ymtszw$elm_slides$Router$fileAndCursor = function (hash) {
	...
	if (_p0.ctor === '[]') {
		...
		if (_p0._1.ctor === '[]') {
			...
			var _p2 = _p0._0;
			var _p1 = _elm_lang$core$String$toInt(_p0._1._0);
			if (_p1.ctor === 'Ok') {
				return {ctor: '_Tuple2', _0: _p2, _1: _p1._0 - 1};
			} else {
				return {ctor: '_Tuple2', _0: _p2, _1: 0};
			}
		}
	}
};
var _ymtszw$elm_slides$Router$route = F2(
	function (_p4, _p3) {
		var _p5 = _p4;
		var _p9 = _p5;
		var _p6 = _p3;
		var _p7 = _ymtszw$elm_slides$Router$fileAndCursor(_p6.hash);
		var filename = _p7._0;
		var cursor = _p7._1;
		var _p8 = A2(_elm_lang$core$Dict$get, filename, _p5.index);
		if ((_p8.ctor === 'Just') && (_p8._0.ctor === '::')) {
			return {
				ctor: '_Tuple2',
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					_p9,
					{cursor: cursor}),
				_1: _ymtszw$elm_slides$File$getMarkdown(filename)
			};
		}
	});
...
var _ymtszw$elm_slides$View$page = F3(
	function (cursor, index, content) {
		...
		return _elm_lang$core$Native_Utils.eq(cursor, index) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('slide is-active'),
				_1: {ctor: '[]'}
			},
			contents) : ((_elm_lang$core$Native_Utils.cmp(index, cursor) < 0) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('slide is-overlay is-left-deck'),
				_1: {ctor: '[]'}
			},
			contents) : A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('slide is-overlay is-right-deck'),
				_1: {ctor: '[]'}
			},
			contents));
	});
var _ymtszw$elm_slides$View$locatorButton = F5(
	function (disabled_, filename, toCursor, others, children) {
		return disabled_ ? A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'/',
								_elm_lang$core$Basics$toString(toCursor))))),
				_1: others
			},
			children);
	});
var _ymtszw$elm_slides$View$locator = F3(
	function (max, filename, cursor) {
		return A2(
			_elm_lang$html$Html$nav,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('pagination is-centered'),
				_1: {
					ctor: '::',
			...
			},
			{
				ctor: '::',
				_0: A5(
					_ymtszw$elm_slides$View$locatorButton,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('pagination-list'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(cursor + 1)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('/'),
								_1: {
...
var _ymtszw$elm_slides$View$rendered = function (_p0) {
	...
	if (_p2.ctor === 'Just') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('reveal'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
if (typeof _ymtszw$elm_slides$Main$main !== 'undefined') {
    _ymtszw$elm_slides$Main$main(Elm['Main'], 'Main', undefined);
}
